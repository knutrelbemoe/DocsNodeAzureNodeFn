...
module.exports = function (context, req) {
    ...
    var options = {
        method: "GET",
        uri: resource + "/sites/DocsNodeAdmin/_api/web/GetFolderByServerRelativeUrl('/sites/DocsNodeAdmin/DocsNodeTemplatesLibrary/" + folderPath + "')?$select=*&$expand=Folders,Files/ListItemAllFields/FieldValuesAsText",
        headers: {
            'Authorization': token,
